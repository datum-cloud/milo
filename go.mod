...
require (
	buf.build/gen/go/datum-cloud/iam/grpc-ecosystem/gateway/v2 v2.26.3-00000000000000-9856dedd4387.1
	buf.build/gen/go/datum-cloud/iam/grpc/go v1.5.1-00000000000000-9856dedd4387.2
	buf.build/gen/go/datum-cloud/iam/protocolbuffers/go v1.36.6-00000000000000-9856dedd4387.1
