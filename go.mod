...
require (
	buf.build/gen/go/datum-cloud/iam/grpc-ecosystem/gateway/v2 v2.26.3-20250416133839-f53373f380ba.1
	buf.build/gen/go/datum-cloud/iam/grpc/go v1.5.1-20250416133839-f53373f380ba.2
