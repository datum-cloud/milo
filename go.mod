...
require (
	buf.build/gen/go/datum-cloud/iam/grpc-ecosystem/gateway/v2 v2.26.3-20250422134958-183ba2445124.1
	buf.build/gen/go/datum-cloud/iam/grpc/go v1.5.1-20250422134958-183ba2445124.2
	buf.build/gen/go/datum-cloud/iam/protocolbuffers/go v1.36.6-20250422134958-183ba2445124.1
