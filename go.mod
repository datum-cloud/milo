...
require (
	buf.build/gen/go/datum-cloud/iam/grpc-ecosystem/gateway/v2 v2.26.3-20250522191909-c33f1c0d984f.1
	buf.build/gen/go/datum-cloud/iam/grpc/go v1.5.1-20250522191909-c33f1c0d984f.2
