...
(GroupMembership content unchanged)
...
(PlatformAccessApproval content unchanged)

## PlatformAccessDenial
<sup><sup>[↩ Parent](#iammiloapiscomv1alpha1 )</sup></sup>

(PlatformAccessDenial content unchanged)

## PlatformAccessRejection
<sup><sup>[↩ Parent](#iammiloapiscomv1alpha1 )</sup></sup>

(PlatformAccessRejection content unchanged)

## PlatformInvitation
<sup><sup>[↩ Parent](#iammiloapiscomv1alpha1 )</sup></sup>

(PlatformInvitation content unchanged)

## PolicyBinding
<sup><sup>[↩ Parent](#iammiloapiscomv1alpha1 )</sup></sup>

(PolicyBinding content unchanged up to subjects[index])
...
(PolicyBinding.status, rest unchanged)

## ProtectedResource
<sup><sup>[↩ Parent](#iammiloapiscomv1alpha1 )</sup></sup>

(ProtectedResource content unchanged)
...
(UserDeactivation content unchanged)

## UserInvitation
<sup><sup>[↩ Parent](#iammiloapiscomv1alpha1 )</sup></sup>

(UserInvitation content unchanged)

## UserPreference
<sup><sup>[↩ Parent](#iammiloapiscomv1alpha1 )</sup></sup>

(UserPreference content unchanged)
