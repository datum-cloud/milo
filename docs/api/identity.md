...
This resource allows users to manage API keys for service-to-service and automation authentication. When a ServiceAccountKey is created, the system generates a private key that is returned in the status only once.
