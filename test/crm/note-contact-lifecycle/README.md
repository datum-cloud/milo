...
End-to-end tests for CRM Notes and Notification Contacts.
...
- Deleting a User causes owned Contacts to be garbage-collected via ownerReferences
...
|:-:|---|:-:|:-:|:-:|:-:|:-:|
| 1 | [create-user-contact-and-notes](#step-create-user-contact-and-notes) | 0 | 6 | 0 | 0 | 0 |
