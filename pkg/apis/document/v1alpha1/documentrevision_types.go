...
// DocumentRevisionExpectedResourceKind is the kind of the resource that is expected to reference this revision.
// +kubebuilder:validation:Type=object
type DocumentRevisionExpectedResourceKind struct {
...
type DocumentRevisionSpec struct {
	...
	// +kubebuilder:validation:Required
	ExpectedSubjectKinds []DocumentRevisionExpectedResourceKind `json:"expectedSubjectKinds"`

	// ExpectedAccepterKinds is the resource kinds that are expected to accept this revision.
	// +kubebuilder:validation:Required
	ExpectedAccepterKinds []DocumentRevisionExpectedResourceKind `json:"expectedAccepterKinds"`
}
