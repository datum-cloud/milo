...
func NewCELEngine(logger logr.Logger) (CELEngine, error) {
	...
	env, err := cel.NewEnv(
		// Trigger resource (admitted object)
		...
		// Context variables (namespace removed; use requestInfo.namespace instead)
		// Expose the Group/Version/Kind of the triggering object explicitly
		cel.Variable("triggerGVK", cel.ObjectType("gvk")),
		cel.Variable("triggerGVK.group", cel.StringType),
		cel.Variable("triggerGVK.version", cel.StringType),
		cel.Variable("triggerGVK.kind", cel.StringType),
...
func (e *celEngine) buildVariableMap(evalCtx *EvaluationContext) (map[string]interface{}, error) {
	...
	if evalCtx.Object != nil {
		vars["trigger"] = evalCtx.Object.Object
	}
	...
	// Context variables
	vars["triggerGVK.group"] = evalCtx.GVK.Group
	vars["triggerGVK.version"] = evalCtx.GVK.Version
	vars["triggerGVK.kind"] = evalCtx.GVK.Kind
