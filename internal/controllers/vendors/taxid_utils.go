...
func GetTaxIdFromSecret(ctx context.Context, c client.Client, vendor *vendorsv1alpha1.Vendor, taxIdRef vendorsv1alpha1.TaxIdReference) (string, error) {
...
func ValidateTaxIdSecret(ctx context.Context, c client.Client, vendor *vendorsv1alpha1.Vendor, taxIdRef vendorsv1alpha1.TaxIdReference) error {
	// Determine the namespace for the Secret
	namespace := taxIdRef.Namespace
	if namespace == "" {
		namespace = vendor.Namespace
...
func CreateTaxIdSecret(ctx context.Context, c client.Client, vendor *vendorsv1alpha1.Vendor, taxIdRef vendorsv1alpha1.TaxIdReference, taxId string) error {
	// Determine the namespace for the Secret
	namespace := taxIdRef.Namespace
	if namespace == "" {
		namespace = vendor.Namespace
...
func UpdateTaxIdSecret(ctx context.Context, c client.Client, vendor *vendorsv1alpha1.Vendor, taxIdRef vendorsv1alpha1.TaxIdReference, taxId string) error {
	// Determine the namespace for the Secret
	namespace := taxIdRef.Namespace
	if namespace == "" {
		namespace = vendor.Namespace
...
func DeleteTaxIdSecret(ctx context.Context, c client.Client, vendor *vendorsv1alpha1.Vendor, taxIdRef vendorsv1alpha1.TaxIdReference) error {
	// Determine the namespace for the Secret
	namespace := taxIdRef.Namespace
	if namespace == "" {
		namespace = vendor.Namespace
